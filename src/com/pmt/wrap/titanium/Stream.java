...
public class Stream {
	 ...
	 * <p>
	 * <b>Platforms:</b> iphone android ipad, <b>Since:</b> 1.7
	 * @param inputStream (<a href="Titanium.IOStream-object.html">Titanium.IOStream</a>) Stream to pump from
	 ...
	 * <p>
	 * <b>Platforms:</b> iphone android ipad, <b>Since:</b> 1.7
	 * @param sourceStream (<a href="Titanium.IOStream-object.html">Titanium.IOStream</a>) Stream to read from
	 * @param buffer (<a href="Titanium.Buffer-object.html">Titanium.Buffer</a>) Buffer to read into
	 ...
	 * @param resultsCallback (Function) called with result of the read operation.  Callback parameter has these members: <tt>source</tt>, the stream being read.  <tt>bytesProcessed</tt>, the number of bytes read.  <tt>errorState</tt>, an error state if any.  <tt>errorDescription</tt>, an error description if any.
	 * @return void
	 */
	 ...
	 * <b>Platforms:</b> iphone android ipad, <b>Since:</b> 1.7
	 * @param sourceStream (<a href="Titanium.IOStream-object.html">Titanium.IOStream</a>) Stream to read from
	 * @param buffer (<a href="Titanium.Buffer-object.html">Titanium.Buffer</a>) Buffer to read into.  OPTIONAL: use only if you want an asynchronous read.
	 ...
	 * <p>
	 * <b>Platforms:</b> iphone android ipad, <b>Since:</b> 1.7
	 * @param outputStream (<a href="Titanium.IOStream-object.html">Titanium.IOStream</a>) Stream to write to
	 * @param buffer (<a href="Titanium.Buffer-object.html">Titanium.Buffer</a>) Buffer to write from
	 ...
	 * @param resultsCallback (Function) called with result of the write operation. Callback parameter has these members: <tt>source</tt>, the stream being written to.  <tt>bytesProcessed</tt>, the number of bytes written.  <tt>errorState</tt>, an error state if any.  <tt>errorDescription</tt>, an error description if any.
	 * @return void
	 */
	 ...
	 * <p>
	 * <b>Platforms:</b> iphone android ipad, <b>Since:</b> 1.7
	 * @param inputStream (<a href="Titanium.IOStream-object.html">Titanium.IOStream</a>) Stream to read from
	 * @param outputStream (<a href="Titanium.IOStream-object.html">Titanium.IOStream</a>) Stream to write to
