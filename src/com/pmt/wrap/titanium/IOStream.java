...
public class IOStream {
	...
	public IOStream(JavaScriptObject handler) {
	 ...
	 */
	 public native void close() /*-{
		return this.@com.pmt.wrap.titanium.IOStream::handler.close();
	}-*/;
	 ...
	 */
	 public native boolean isReadable() /*-{
		return this.@com.pmt.wrap.titanium.IOStream::handler.isReadable();
	}-*/;
	 ...
	 */
	 public native boolean isWriteable() /*-{
		return this.@com.pmt.wrap.titanium.IOStream::handler.isWriteable();
	}-*/;
	 ...
	 */
	 public native double read(JavaScriptObject buffer, double offset, double length) /*-{
		return this.@com.pmt.wrap.titanium.IOStream::handler.read(buffer, offset, length);
	}-*/;
	 ...
	 */
	 public native double write(JavaScriptObject buffer, double offset, double length) /*-{
		return this.@com.pmt.wrap.titanium.IOStream::handler.write(buffer, offset, length);
	}-*/;
}
