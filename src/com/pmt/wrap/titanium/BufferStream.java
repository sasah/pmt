...
public class BufferStream {
	...
	public BufferStream(JavaScriptObject handler) {
	 ...
	 */
	 public native boolean isReadable() /*-{
		return this.@com.pmt.wrap.titanium.BufferStream::handler.isReadable();
	}-*/;
	 ...
	 */
	 public native boolean isWriteable() /*-{
		return this.@com.pmt.wrap.titanium.BufferStream::handler.isWriteable();
	}-*/;
	 ...
	 */
	 public native double read(JavaScriptObject buffer, double offset, double length) /*-{
		return this.@com.pmt.wrap.titanium.BufferStream::handler.read(buffer, offset, length);
	}-*/;
	 ...
	 */
	 public native double write(JavaScriptObject buffer, double offset, double length) /*-{
		return this.@com.pmt.wrap.titanium.BufferStream::handler.write(buffer, offset, length);
	}-*/;
}
